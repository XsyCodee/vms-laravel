...
<x-filament-panels::layout.login :livewire="$livewire">
    @props([
        'after' => null,
        'heading' => null,
        'subheading' => null,
    ...
    <div class="fi-simple-layout flex min-h-screen flex-col items-center">
        ...
        >
            <main
                @class([
                    'fi-simple-main my-16 w-full bg-white/95 backdrop-blur-sm px-6 py-12 shadow-xl ring-1 ring-gray-950/5 dark:bg-gray-900/95 dark:ring-white/10 sm:rounded-2xl sm:px-12',
...
</x-filament-panels::layout.login>